...
class BookingRecordsExchangeService
{
    public function booking_records(int $id, string $bearerToken)
    {
        $method = 'get';
        $endpoint = '/bookingRecords/' . $id;
        $baseUrl = env('APP_BOOKING_SERVICE_URL');
